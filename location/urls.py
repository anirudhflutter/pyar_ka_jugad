...
urlpatterns = [
    ...
    path("add_all_countries/", views.add_all_countries, name="add_all_countries"),
    path(
        "get_all_states_of_country/",
        views.get_all_states_of_country,
        name="get_all_states_of_country",
    ),
    path("add_all_states_of_country/", views.add_all_states_of_country, name="add_all_states_of_country"),
    path(
        "get_all_cities_of_state/",
        views.get_all_cities_of_state,
        name="get_all_cities_of_state",
    ),
    path("add_all_cities_of_state/", views.add_all_cities_of_state, name="add_all_cities_of_state"),
]
